...
[ ] Move away from lodash to native methods
[ ] move request methods to axios as request is now deprecated
[ ] modernize constructor functions into modern classes
*/
...
class Location {
  constructor(json) {
    ...
    this.postcode = json.ocationInfo.postcode;
...
Session.prototype.getThermostats = function (locationId) {
  ...
  return this._request(url).then(function (json) {
    return _.map(json.gateways[0].temperatureControlSystems[0].zones, function (
      t
    ) {
