  ...
  getThermostats(locationId) {
    ...
    return this.requestData(url).then(function (json) {
      return json.gateways[0].temperatureControlSystems[0].zones.map((t) => {
        ...
        // BATTERY LOW
        // 'activeFaults': [{faultType: 'TempZoneSensorLowBattery', since: '2020-05-15T23:07:18'},
        //                  {faultType: 'TempZoneActuatorLowBattery', since: '2020-05-15T23:07:18'}]
        // COMMUNICATION ERROR
        // 'activeFaults': [{'faultType': 'TempZoneSensorCommunicationLost', 'since': '2020-04-21T10:41:38'},
